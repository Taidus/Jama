...
public enum Role {
	...
	OPERATOR(new Permission[] { Permission.ALTER_CONTRACTS, Permission.DELETE_CONTRACTS, Permission.VIEW_CONTRACTS, Permission.VIEW_HOME },
			"Operatore"),

	CHIEF_SCIENTIST(new Permission[] { Permission.VIEW_OWN_CONTRACTS, Permission.VIEW_HOME }, "Responsabile scientifico"),
