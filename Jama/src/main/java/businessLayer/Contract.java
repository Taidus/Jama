...
public abstract class Contract implements Serializable {
	...
	protected String CIA_projectNumber;
	protected String inventoryNumber;

	private boolean closed;

	@Embedded
	@AttributeOverrides({ @AttributeOverride(name = "money", column = @Column(name = "SPENT_AMOUNT")),
	...
	@Embedded
	@AttributeOverrides({ @AttributeOverride(name = "money", column = @Column(name = "WHOLE_TAXABLE_AMOUNT")),
