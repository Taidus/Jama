...
\section{Collaudo}
 ...
 \footnotesize
  ...
  \caption{Scenario \ref{MS1}} \\
    ...
    \hline
    2 & L'Operatore clicca sul pulsante ``Aggiungi" di fianco al campo ditta & Viene visualizzata una finestra di dialogo contenente i dati della ditta da inserire & Uguale al risultato atteso & Sì\\
    \hline
    3 & L'Operatore inserisce i dati e clicca su ``Salva" & Si ritorna al primo passo della procedura, la ditta appena creata è selezionata automaticamente nel menù a tendina & Uguale al risultato atteso & Sì\\
    \hline
...
\begin{figure}[h!]
	\centering
	\scalebox{0.28}{\includegraphics{Tab_Dati.png}}
...
\begin{figure}[h!]
	\centering
	\scalebox{0.5}{\includegraphics{Aggiungi_Ditta_Dialog.png}}
...
\begin{figure}[h!]
	\centering
	\scalebox{0.28}{\includegraphics{Tab_Rip.png}}
...
\begin{figure}[h!]
	\centering
	\scalebox{0.28}{\includegraphics{Tab_Rip_Rata.png}}
...
\begin{figure}[h!]
	\centering
	\scalebox{0.25}{\includegraphics{Lista_Convenzioni.png}}
...
\begin{figure}[h!]
	\centering
	\scalebox{0.25}{\includegraphics{Lista_Rate_Modifica.png}}
...
\begin{figure}[h!]
	\centering
	\scalebox{0.25}{\includegraphics{Lista_ditte_modifica.png}}
...
\begin{figure}[h!]
	\centering
	\scalebox{0.3}{\includegraphics{Dialog_Ditta_Modifica.png}}
...
\begin{figure}[h!]
	\centering
	\scalebox{0.28}{\includegraphics{Tab_Dati_Contributo.png}}
...
\begin{figure}[h!]
	\centering
	\scalebox{0.25}{\includegraphics{Allegati.png}}
...
\begin{figure}
	\centering
	\scalebox{0.25}{\includegraphics{Fine_Contributo.png}}
...
\begin{figure}
	\centering
	\scalebox{0.28}{\includegraphics{Tab_Dati_visualizzazione.png}}
...
\begin{figure}
	\centering
	\scalebox{0.25}{\includegraphics{Allegato_Inserito.png}}
...
\begin{figure}[h!]
	\centering
	\scalebox{0.25}{\includegraphics{Creazione_Utente.png}}
...
\begin{figure}[h!]
	\centering
	\scalebox{0.25}{\includegraphics{Lista_utenti.png}}
